        ...
        public List<String> OnMessage(String sInMessage)
        {
            ...
            switch (this.nCur)
            {
                case State.WELCOMING:
                    aMessages.Add("Welcome to PizzOnFly!");
                    aMessages.Add("What type Pizza Size you want (S,L,XL)?");
                    this.nCur = State.SIZE;
                    break;
                case State.SIZE:
                    this.oOrder.Size = sInMessage;
                    this.oOrder.Save();
                    aMessages.Add("What protein thing would you like on this  " + this.oOrder.Size + " Shawarama?");
